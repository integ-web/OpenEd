...
|---|---:|---|---|---|
| P4.L1 — Spatial Reasoning and World Models | 60 min | Define spatial/world-model evaluation and explain why text-only metrics are insufficient. | Spatial Evaluation Frame | external reference video + authored transcript ready |
| P4.L2 — Object Permanence, Physical Consistency, and Temporal Coherence | 75 min | Design tests for object permanence, physics plausibility, and temporal consistency. | Physical Consistency Test Card | external reference video + authored transcript ready |
| P4.L3 — ARC-AGI-2 and Abstract Generalization | 75 min | Explain how ARC-style tasks test abstraction and sample-efficient generalization. | Abstract Generalization Note | external reference video + authored transcript ready |
| P4.L4 — Multimodal Benchmark Design | 75 min | Design multimodal tasks that combine visual, textual, and structured evidence. | Multimodal Benchmark Packet | external reference video + authored transcript ready |
| P4.L5 — Simulation Benchmarks: RLBench, VIMA, and Factory Layouts | 105 min | Use simulation benchmarks to design safe physical reasoning tasks. | Simulation Benchmark Spec | external reference video + authored transcript ready |
| P4.L6 — Video and Interactive World-Model Evaluation | 75 min | Evaluate video/world-model claims using consistency, controllability, and interaction tests. | World-Model Claim Checklist | external reference video + authored transcript ready |
...
- primaryVideoTitle: ARC-AGI-2 Overview With François Chollet
- primaryVideoProvider: YouTube / ARC Prize
- primaryVideoUrl: https://www.youtube.com/watch?v=TWHezX43I-4
...
- primaryVideoTitle: RLBench: The Robot Learning Benchmark
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=F2PqREHT3F8
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: ARC Prize Version 2 Launch Video
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=M3b59lZYBW8
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: MM-SafetyBench: A Benchmark for Safety Evaluation of Multimodal Large Language Models
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=1j2Jz6oJ4Uo
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: RLBench 2019 — Comparing Robot Learning Algorithms on 100 Tasks
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=blt0l8cQqZo
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: Stanford CME295 Transformers & LLMs — Quantifying LLM Performance
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=8fNP4N46RRo
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: RLBench Task Building Tutorial — Target Reaching Part 1
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=bKaK_9O3v7Y
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
|---|---|---|---|---|
| P4.L1 | Reference video — Spatial Reasoning and World Models | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P4.L2 | Reference video — Object Permanence, Physical Consistency, and Temporal Coherence | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P4.L3 | Reference video — ARC-AGI-2 and Abstract Generalization | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P4.L4 | Reference video — Multimodal Benchmark Design | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P4.L5 | Reference video — Simulation Benchmarks: RLBench, VIMA, and Factory Layouts | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P4.L6 | Reference video — Video and Interactive World-Model Evaluation | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P4.L7 | Reference video — Phase Studio: Physical Simulation Benchmark | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
