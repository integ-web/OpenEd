...
|---|---:|---|---|---|
| P6.L1 — Telemetry and Production Evaluation | 60 min | Define production telemetry that supports safety, quality, cost, and drift decisions. | Telemetry Schema | external reference video + authored transcript ready |
| P6.L2 — TTFT, Latency, Concurrency, and Cost | 45 min | Measure service-level performance without confusing speed with capability or safety. | Performance Gate Spec | external reference video + authored transcript ready |
...
| P6.L4 — Threshold Memos and Governance Frameworks | 60 min | Translate evaluation evidence into threshold memos aligned with governance frameworks. | Threshold Memo | external reference video + authored transcript ready |
...
- primaryVideoTitle: Drift Monitoring and Evaluation for LLM Apps
- primaryVideoProvider: YouTube / Evidently AI
- primaryVideoUrl: https://www.youtube.com/watch?v=eQ6cGzDUtMU
...
- primaryVideoTitle: LLM Inference Performance: Latency and Throughput Metrics
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=DW-mo65DJ-Q
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: Evidently AI Tutorial — Open Source ML Models Monitoring and Testing
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=cgc3dSEAel0
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: 80,000 Hours Podcast — Anthropic’s Responsible Scaling Policy with Nick Joseph
- primaryVideoProvider: Podcast / YouTube optional on page
- primaryVideoUrl: https://80000hours.org/podcast/episodes/nick-joseph-anthropic-safety-approach-responsible-scaling/
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: Deep Dive into LLM Evaluation with Weights & Biases
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://www.youtube.com/watch?v=7EcznH0-of8
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
- primaryVideoTitle: Software Engineering and LLM Evaluation
- primaryVideoProvider: YouTube
- primaryVideoUrl: https://m.youtube.com/watch?v=tIgPbjPav4o
- primaryVideoStatus: EXTERNAL_REFERENCE_UNVERIFIED
- embedVerified: false
- embedCheckRequired: true
- fallbackRequired: true
...
|---|---|---|---|---|
| P6.L1 | Reference video — Telemetry and Production Evaluation | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P6.L2 | Reference video — TTFT, Latency, Concurrency, and Cost | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P6.L3 | Reference video — Drift, Regression Gates, and CI/CD | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P6.L4 | Reference video — Threshold Memos and Governance Frameworks | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P6.L5 | Reference video — Capstone Studio: Aster-3 Evaluation Dossier | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
| P6.L6 | Reference video — Final Portfolio Export, QA, and Deployment Gate | EXTERNAL_REFERENCE_UNVERIFIED_AUTHORED_TRANSCRIPT_READY | yes | no external primary |
