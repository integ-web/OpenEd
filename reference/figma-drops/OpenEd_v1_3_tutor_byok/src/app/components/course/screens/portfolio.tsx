...
export function PortfolioScreen({ state, navigate, update }: ScreenProps) {
  ...
  // Artifact cards
  const artifacts = [
    { label: 'Frontier AI Landscape Map',  module: 'A', nav: 'map' as const,       done: state.completedModules.includes('A'),           desc: 'Visual map of frontier models, capability profiles, and evaluation institutions.' },
    { label: 'Threat Model Document',       module: 'B', nav: 'modules' as const,   done: state.completedModules.includes('B'),           desc: 'Formal threat model covering actors, pathways, assumptions, and consequence severity.' },
    { label: 'Evaluation Design Document',  module: 'C', nav: 'modules' as const,   done: state.completedModules.includes('C'),           desc: 'Evaluation objectives, elicitation protocol, metrics, and validity analysis.' },
    ...
    { label: 'Red Team Report',             module: 'H', nav: 'modules' as const,   done: state.completedModules.includes('H'),           desc: state.completedModules.includes('H') ? 'Red team program design, findings log, and escalation decisions.' : 'Complete Module H to generate this artifact.' },
