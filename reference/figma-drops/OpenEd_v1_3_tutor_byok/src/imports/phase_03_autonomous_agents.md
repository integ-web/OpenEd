...
|---|---:|---|---|---|
| P3.L1 — Why Agent Evaluation Is Different | 75 min | Explain why agents require environment, state, tool, and trajectory evaluation. | Agent Evaluation Frame | candidate external |
...
| P3.L3 — SWE-bench and Coding Agent Evaluation | 105 min | Interpret execution-based software engineering benchmarks and their caveats. | Coding Agent Benchmark Card | candidate external |
| P3.L4 — OSWorld, WebArena, and GAIA | 105 min | Compare environment-based agent benchmarks and choose which fits a task claim. | Agent Benchmark Selection Matrix | candidate external |
...
| P3.L6 — Long Task Horizons, Autonomy, and ARA | 105 min | Explain long-task time horizons and autonomous replication/adaptation as evaluation frames. | Autonomy Risk Frame | candidate external |
...
- videoTitle: Measuring AI Ability to Complete Long Tasks
- videoProvider: YouTube
- videoUrl: https://www.youtube.com/watch?v=9U15vncqdnk
- videoDuration: External talk; confirm timestamp after embedding
- videoStatus: candidate-external-verify-before-publishing
- transcriptButton: show
- captionsButton: show
